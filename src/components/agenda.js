        ...
        {props.data.map(slot => (
          <div>
            ...
            {slot.items.length === 2 &&
              <Columns isMarginless={true} isPaddingless={true}>
                {slot.items.map(item => (
                  <Column isSize="1/2" hasTextAlign="center" isMarginless={true} isPaddingless={true}>
                    {item}
                  </Column>
                ))}
              </Columns>
            ...
            {slot.items.length === 3 &&
              <Columns isMarginless={true} isPaddingless={true}>
                {slot.items.map(item => (
                  <Column isSize="1/3" hasTextAlign="center" isMarginless={true} isPaddingless={true}>
                    {item}
                  </Column>
                ))}
              </Columns>
            ...
            {slot.items.length === 4 &&
              <Columns isMarginless={true} isPaddingless={true}>
                {slot.items.map(item => (
                  <Column isSize="1/4" hasTextAlign="center" isMarginless={true} isPaddingless={true}>
                    {item}
                  </Column>
                ))}
              </Columns>
